<?php /*a:1:{s:52:"D:\phpstudy_pro\WWW\atp6\app\back\view\rule\add.html";i:1608615965;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
	<form class="layui-form">
		...
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      	<input type="text" name="url" autocomplete="off" placeholder="必填，一级功能URL为/，其余 /back/xx/xx" class="layui-input" lay-verify="required|my_url">
		    </div>
		</div>
		<div class="layui-form-item">
		    <label class="layui-form-label">功能排序：</label>
		    <div class="layui-input-block">
		      	<input type="text" name="sort" autocomplete="off" placeholder="同一父级下的排序" class="layui-input" lay-verify="my_num">
		    </div>
		</div>
		<div class="layui-form-item">
